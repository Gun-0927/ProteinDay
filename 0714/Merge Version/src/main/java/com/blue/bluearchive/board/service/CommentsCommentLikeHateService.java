...
public class CommentsCommentLikeHateService {
    ...
    public CommentsCommentLikeHateDto likeCommentsComment(int commentsCommentId, Long idx) {
        ...
        return new CommentsCommentLikeHateDto(likeCount, hateCount,likeHate.isLike(),likeHate.isHate());
    }
    ...
    public boolean isLiked(int commentsCommentId, Long idx) {
        CommentsCommentLikeHate commentsCommentLikeHate = commentsCommentLikeHateRepository.findByCommentsCommentCommentsCommentIdAndMemberIdx(commentsCommentId, idx);
        return commentsCommentLikeHate != null && commentsCommentLikeHate.isLike();
    }

    public boolean isHated(int commentsCommentId, Long idx) {
        CommentsCommentLikeHate commentsCommentLikeHate = commentsCommentLikeHateRepository.findByCommentsCommentCommentsCommentIdAndMemberIdx(commentsCommentId, idx);
        return commentsCommentLikeHate != null && commentsCommentLikeHate.isHate();
    }
